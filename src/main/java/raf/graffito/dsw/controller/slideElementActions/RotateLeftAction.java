...
// Akcija za rotaciju selektovanih elemenata za 90 stepeni ulevo
public class RotateLeftAction extends AbstractGraffAction {
    private final SlideView slideView;

    public RotateLeftAction(SlideView slideView) {
        super("Rotate Left", "Rotate selected elements 90° left");
